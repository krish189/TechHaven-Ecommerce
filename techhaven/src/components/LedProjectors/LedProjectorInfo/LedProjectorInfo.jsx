    ...
    <div className='image-wrapper'>
      ...
      <div className='info'>
        {ledprojectordata && ledprojectordata.map((ledprojector,index)=>(
          ...
          {ledprojector.lens_shift && <p><span className='spechead'>Lens Shift</span><span className='specvalue' style={{position: 'relative', left: '7.6rem'}}>{ledprojector.lens_shift ? 'Yes' : 'No'}</span></p>}
          {ledprojector.keystone_correction && <p><span className='spechead'>Keystone Correction</span><span className='specvalue' style={{position: 'relative', left: '2.8rem'}}>{ledprojector.keystone_correction ? 'Yes' : 'No'}</span></p>}
          ...
          {ledprojector.three_d_support && <p><span className='spechead'>3d Support</span><span className='specvalue' style={{position: 'relative', left: '6.9rem'}}>{ledprojector.three_d_support ? 'Yes' : 'No'}</span></p>}
          {ledprojector.remote_control && <p><span className='spechead'>Remote Control</span><span className='specvalue' style={{position: 'relative', left: '4.8rem'}}>{ledprojector.remote_control ? 'Yes' : 'No'}</span></p>}
          ...
          {ledprojector.hdr_support && <p><span className='spechead'>HDR Support</span><span className='specvalue' style={{position: 'relative', left: '6rem'}}>{ledprojector.hdr_support ? 'Yes' : 'No'}</span></p>}
          ...
          {ledprojector.bluetooth_audio && <p><span className='spechead'>Bluetooth Audio</span><span className='specvalue' style={{position: 'relative', left: '4.3rem'}}>{ledprojector.bluetooth_audio ? 'Yes' : 'No'}</span></p>}
          {ledprojector.smart_features && <p><span className='spechead'>Smart Features</span><span className='specvalue' style={{position: 'relative', left: '5rem'}}>{ledprojector.smart_features ? 'Yes' : 'No'}</span></p>}
