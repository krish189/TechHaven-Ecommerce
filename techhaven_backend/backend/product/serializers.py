...
# Create a serializer for the Smart Lighting model
class SmartLightingSerializer(serializers.ModelSerializer):
    class Meta:
        model = SmartLighting
        fields = '__all__'

# Create a serializer for the CCTV Camera model
class CCTVSerializer(serializers.ModelSerializer):
    class Meta:
        model = CCTVCamera
        fields = '__all__'

# Create a serializer for the Smart Watch model
